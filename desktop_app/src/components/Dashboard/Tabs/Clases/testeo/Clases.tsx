...
export default function Lessons({ handleSelectTab, WichEndPoint }) {
  ...
  useEffect(() => {
    if (currentGif === Object.keys(giftsLessons1)[Object.keys(giftsLessons1).length - 1]) {
...
const handleNextGif = () => {
  const gifKeys = Object.keys(giftsLessons1);
  ...
  if (nextGifIndex === gifKeys.length - 1) {
    setShowCarousel(true);
  }
};
    ...
    <div className="flex flex-col h-screen mx-auto">
      ...
      <div className="flex flex-grow justify-center items-center">
        ...
        {/* @ts-ignore */}
          ...
          <ImgDisplay gifImage={giftsLessons1[currentGif]} />
        )}
