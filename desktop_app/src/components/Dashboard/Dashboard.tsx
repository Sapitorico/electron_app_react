      ...
      <div>
        <ul className="tabs tabs-boxed flex-col items-stretch drop-shadow-lg">
          ...
          <li
            ...
            className={`stat ${selectedTab === 'educacion' || selectedTab === 'clases' ? 'dashTags flex items-center' : 'flex items-center text-xl font-semibold'
              }`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <li
            ...
            className={`stat ${selectedTab === 'practica' ? 'dashTags flex items-center' : 'flex items-center'}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <li
            ...
            className={`stat ${selectedTab === 'glosario' ? 'dashTags flex items-center' : 'flex items-center'}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
